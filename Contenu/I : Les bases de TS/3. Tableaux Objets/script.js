...
let nums; // ? Type numberArray : let nums: number[], ce qui signifie que nums est pour l'instant undefined mais qu'il pourra contenir seulement un array de nombres
...
let nums2 = []; // ? Type numberArray : let nums2: number[], ce qui signifie que nums2 est pour l'instant un array vide mais qu'il pourra contenir seulement des nombres
...
let random; // ? Type anyArray : let random: any[], ce qui signifie que random est pour l'instant undefined mais qu'il pourra contenir un array avec des valeurs de n'importe quel type
...
let profile; // ? Type object : let profile: { name: string; age: number;}, ce qui signifie que profile est pour l'instant undefined mais qu'il pourra contenir un object avec deux keys: name qui sera un string, et age qui sera un number
profile = {
    name: "John",
    age: 85,
...
let obj; // ? Type object : let obj: object, ce qui signifie que obj est pour l'instant undefined mais qu'il pourra contenir un object 
obj = {
    name: "John",
    age: 85
