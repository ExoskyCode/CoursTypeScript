...
let nums : number[]; // ? type number : let nums: number[] ce qui signifie que nums est pour l'instant undefined mais qu'il pourra contenir seulement un array de nombres